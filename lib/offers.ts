...
export const offers: Offer[] = [
...

  {
    ...
    image: "/offres/fling-premium.webp",
...

  {
    ...
    image: "/offres/waystomeet-premium.webp",
  ...
  },
  {
    ...
    category: "gaming",
    rating: 4.6,
    affiliate: "https://t.bbwafx.com/197466/10229/0?aff_sub5=SF_006OG000004lmDN",
    image: "/offres/haremvilla.webp",
    description: "Jeu adulte de puzzle de fusion mêlant rénovation de villa, histoire, collection et progression sur PC et mobile.",
    pros: ["Puzzle de fusion", "Accès PC et mobile", "Histoire et collection"],
    cons: ["Achats facultatifs", "Connexion internet nécessaire"],
    keywords: ["Harem Villa", "jeu PC adulte", "jeu adulte gratuit", "jeu adulte mobile"],
    cities: false,
  },
  {
    slug: "pornstar-harem",
    ...
    category: "gaming",
    rating: 4.3,
    affiliate: "https://t.mbagm.link/197466/8403/0?aff_sub5=SF_006OG000004lmDN",
    image: "/offres/pornstarharem.webp",
    description: "Jeu adulte en ligne orienté progression, collection de personnages et fonctions sociales avec clubs.",
    pros: ["Progression", "Collection", "Clubs et clavardage"],
    cons: ["Informations publiques limitées", "Prix à vérifier sur la plateforme"],
    keywords: ["Pornstar Harem", "jeu adulte en ligne", "jeu harem", "jeux adultes navigateur"],
    cities: false,
  },
];

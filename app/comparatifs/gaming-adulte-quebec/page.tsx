...
const offers: ComparisonOffer[] = [
  ...
  { position: 5, name: "Pornstar Harem", rating: "4.3/5", badge: "Meilleur aspect social", badgeColor: "from-violet-500 to-purple-800", best: "Collection, expérience et clubs", description: "Pornstar Harem complète le classement avec une progression de héros, une collection de personnages et des fonctions sociales. La page officielle visible mentionne notamment les clubs et leur clavardage.", imageAlt: "Emplacement du futur visuel Pornstar Harem", affiliate: "https://t.mbagm.link/197466/8403/0?aff_sub5=SF_006OG000004lmDN", review: "/blog/pornstar-harem-avis-quebec", strengths: ["Progression par expérience", "Collection", "Clubs et clavardage"], limits: "Les informations publiques sont moins détaillées; vérifiez la compatibilité, les prix et les modalités directement sur la plateforme.", pricing: "Le modèle économique doit être vérifié au moment de jouer; notre guide n’affirme pas une gratuité complète.", ideal: "Les joueurs intéressés par la collection et une dimension communautaire." },
];
